...
public class PokemonListScreen extends ScreenAdapter {
    private final PokeClone game;
    private final Stage stage;
    private final Skin skin;
    private final Viewport viewport;

    public PokemonListScreen(PokeClone game) {
        this.game = game;
    ...
    public void show() {
        ...
        stage.addActor(new PokemonListView(stage, skin, new PokemonListViewModel(game, game.getPlayerState())));
    }
