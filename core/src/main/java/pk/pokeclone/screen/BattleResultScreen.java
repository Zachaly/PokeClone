...
public class BattleResultScreen extends ScreenAdapter {
    ...
    public BattleResultScreen(PokeClone game) {
        this.game = game;
        viewport = new FitViewport(800f, 450f);
        stage = new Stage(viewport, game.getBatch());
        skin = game.getAssetService().get(SkinAsset.BATTLE);
    }
    ...
    public void show() {
        ...
        stage.addActor(new BattleResultView(stage, skin, new BattleResultViewModel(game, winner, expGain)));
    }
