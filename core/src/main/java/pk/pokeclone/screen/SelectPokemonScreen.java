...
import pk.pokeclone.ui.view.SelectPokemonView;

public class SelectPokemonScreen extends ScreenAdapter {
    private final PokeClone game;
    private final Stage stage;
    private final Skin skin;
    private final Viewport viewport;

    public SelectPokemonScreen(PokeClone game) {
        this.game = game;
    ...
    public void show() {
        ...
        stage.addActor(new SelectPokemonView(stage, skin, new SelectPokemonViewModel(game)));
    }
